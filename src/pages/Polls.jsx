...
const Polls = () => {
  ...
  return (
    <div className="flex  justify-center w-[100%]">
      <div
        className="h-full flex flex-col align-center justify-start shadow h-[100%]"
      ...
      >
        ...
        <div className="flex flex-col ml-5  w-[90%] space-y-8 p-0  h-fit mt-12">
